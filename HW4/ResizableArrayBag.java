...
public class ResizableArrayBag<T> implements BagInterface<T>
{
    ...
    public BagInterface<T> union(BagInterface<T> anotherBag) {
        ...
        ResizableArrayBag<T> temBag = new ResizableArrayBag<>();
        temBag.bag = Arrays.copyOf(argBag.bag, argBag.getCurrentSize());
        temBag.numberOfEntries = argBag.getCurrentSize();
        for (T t : bag) {
            if (t == null) {
                break;
            }
        ...
        return (BagInterface<T>) temBag; 
    }

    @Override
    public BagInterface<T> intersection(BagInterface<T> anotherBag) {
        ResizableArrayBag<T> argBag = (ResizableArrayBag<T>) anotherBag;
        ResizableArrayBag<T> resultBag = new ResizableArrayBag<>(DEFAULT_CAPACITY);
        ResizableArrayBag<T> temBag = new ResizableArrayBag<>(argBag.getCurrentSize());
        temBag.numberOfEntries = argBag.getCurrentSize();
        temBag.bag = Arrays.copyOf(argBag.bag, argBag.getCurrentSize());
        for (T t : bag) {
            if (t == null) {
        ...
        return (BagInterface<T>) resultBag;
    }
